...
DtPerro::DtPerro(const RazaPerro _Raza, bool _vacunaCachorro, std::string NombreMascota, const Genero& Genero, float Peso) : DtMascota(NombreMascota, Genero, Peso) {
	this->Raza = _Raza;
