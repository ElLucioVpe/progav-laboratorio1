...
${OBJECTDIR}/classes/sources/Empleado.o: classes/sources/Empleado.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/classes/sources/Empleado.o classes/sources/Empleado.cpp

${OBJECTDIR}/classes/sources/Empresa.o: classes/sources/Empresa.cpp 
	${MKDIR} -p ${OBJECTDIR}/classes/sources
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/classes/sources/Empresa.o classes/sources/Empresa.cpp

${OBJECTDIR}/classes/sources/EmpresaExtranjera.o: classes/sources/EmpresaExtranjera.cpp 
	${MKDIR} -p ${OBJECTDIR}/classes/sources
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/classes/sources/EmpresaExtranjera.o classes/sources/EmpresaExtranjera.cpp

${OBJECTDIR}/classes/sources/EmpresaNacional.o: classes/sources/EmpresaNacional.cpp 
	${MKDIR} -p ${OBJECTDIR}/classes/sources
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/classes/sources/EmpresaNacional.o classes/sources/EmpresaNacional.cpp

${OBJECTDIR}/classes/sources/RelacionLaboral.o: classes/sources/RelacionLaboral.cpp 
	${MKDIR} -p ${OBJECTDIR}/classes/sources
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/classes/sources/RelacionLaboral.o classes/sources/RelacionLaboral.cpp

${OBJECTDIR}/datatypes/sources/Direccion.o: datatypes/sources/Direccion.cpp 
	${MKDIR} -p ${OBJECTDIR}/datatypes/sources
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/datatypes/sources/Direccion.o datatypes/sources/Direccion.cpp

${OBJECTDIR}/datatypes/sources/DtEmpleado.o: datatypes/sources/DtEmpleado.cpp 
	${MKDIR} -p ${OBJECTDIR}/datatypes/sources
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/datatypes/sources/DtEmpleado.o datatypes/sources/DtEmpleado.cpp

${OBJECTDIR}/datatypes/sources/DtEmpresa.o: datatypes/sources/DtEmpresa.cpp 
	${MKDIR} -p ${OBJECTDIR}/datatypes/sources
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/datatypes/sources/DtEmpresa.o datatypes/sources/DtEmpresa.cpp

${OBJECTDIR}/datatypes/sources/DtEmpresaExtranjera.o: datatypes/sources/DtEmpresaExtranjera.cpp 
	${MKDIR} -p ${OBJECTDIR}/datatypes/sources
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/datatypes/sources/DtEmpresaExtranjera.o datatypes/sources/DtEmpresaExtranjera.cpp

${OBJECTDIR}/datatypes/sources/DtEmpresaNacional.o: datatypes/sources/DtEmpresaNacional.cpp 
	${MKDIR} -p ${OBJECTDIR}/datatypes/sources
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/datatypes/sources/DtEmpresaNacional.o datatypes/sources/DtEmpresaNacional.cpp

${OBJECTDIR}/datatypes/sources/Fecha.o: datatypes/sources/Fecha.cpp 
	${MKDIR} -p ${OBJECTDIR}/datatypes/sources
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/datatypes/sources/Fecha.o datatypes/sources/Fecha.cpp
